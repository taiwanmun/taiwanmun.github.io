/* skel.js v1.0.0 | (c) n33 |  • | MIT licensed */
...
var skel=function() {
    var e="config", t="breakpoints", n="iterate", r="stateId", i="elements", s="getElementsByClassName", o="stateElements", u="getElementsByTagName", a=!1, f="length", l="parentNode", c=null, h="gutters", p="insertBefore", d="push", v=" 0 0 ", m="getCachedElement", g="className", y="!important", b="object", w="cacheNewElement", E="newInline", S="grid", x="config_breakpoint", T="orientationChange", N="locations", C="parseMeasurement", k="createElement", L="match", A="newElement", O="deviceType", M="padding-top:0!important", _="substring", D=!0, P="viewport", H="cache", B="_skel_isReversed", j="}", F="head", I="containers", q="vars", R="indexOf", U="replace", z="padding-top:", W="matchesMedia", X="extend", V="events", $="isArray", J="onorientationchange", K=":first-child>:first-child {", Q="DOMReady", G="getComputedStyle", Y="addEventListener", Z="^head", et="{display:none!important}", tt="padding:", nt="registerLocation", rt="hasOwnProperty", it="defaults", st="documentElement", ot="IEVersion", ut="attachElements", at="horizontal", ft="plugins", lt="attachElement", ct="DOMContentLoaded", ht="text/css", pt="_skel_attach", dt="initial-scale=1", vt="states", mt="firstChild", gt=":first-child>*{", yt="placeholder", bt="removeEventListener", wt=">*{", Et="(min-width: ", St=".row", xt="resize", Tt="media", Nt="applyRowTransforms", Ct="attached", kt="vertical", Lt="normalize", At="change", Ot=".row.uniform", Mt="html", _t="collapse", Dt="forceDefaultState", Pt="_skel_placeholder", Ht="nextSibling", Bt="min-height", jt="max-height", Ft="querySelectorAll", It="prototype", qt="max-width", Rt="innerHTML", Ut="min-width", zt="domready", Wt="android", Xt=".\\3$1 ", Vt="priority", $t="readyState", Jt="onresize", Kt="isStatic", Qt="href", Gt= {
        ...
        ,
        addCachedElementToBreakpoint:function(e,
        n) {
            Gt[t][e]&&Gt[t][e][i][d](n)
        }
        ,
        ...
        r) {
            return {
                id: e, object: t, location: n, priority: r, attached: a
            }
        }
        ,
            ...
            if(!Gt[H][vt][Gt[r]]) {
                ...
                if(c[e][S][_t]) {
                    ...
                    if(!(g=Gt[m](b))) {
                        ...
                        switch(ht) {
                            case 4: break;
                            case 3: T+=":not(.collapse-at-4)";
                            break;
                            case 2: T+=":not(.collapse-at-4):not(.collapse-at-3)";
                            break;
                            case 1: T+=":not(.collapse-at-4):not(.collapse-at-3):not(.collapse-at-2)"
                        }
                        p=Gt[C](c[e][S][h][kt]),
                        pt=p[0]+p[1],
                        p=Gt[C](c[e][S][h][at]),
        ...
        initAPI:function() {
            ...
            switch(Gt[q][O]) {
                case"ios": r[L](/([0-9_]+) like Mac OS X/), e=parseFloat(RegExp.$1[U]("_", ".")[U]("_", ""));
                break;
                case Wt: r[L](/Android ([0-9\.]+)/), e=parseFloat(RegExp.$1);
                break;
                case"mac": r[L](/Mac OS X ([0-9_]+)/), e=parseFloat(RegExp.$1[U]("_", ".")[U]("_", ""));
                break;
                case"wp": r[L](/IEMobile\/([0-9\.]+)/), e=parseFloat(RegExp.$1);
                break;
                case"windows": r[L](/Windows NT ([0-9\.]+)/), e=parseFloat(RegExp.$1);
                break;
                default: e=99
            }
        ...
        initConfig:function(r) {
            ...
            typeof r==b&&(r[t]&&(Gt[e][t]= {}), Gt[X](Gt[e], r)), S in Gt[e]&&h in Gt[e][S]&&typeof Gt[e][S][h]!=b&&(Gt[e][S][h]= {
                vertical: Gt[e][S][h], horizontal: Gt[e][S][h]
            }
            ),
            Gt[X](Gt[it][x][S],
            Gt[e][S]),
            ...
            function(n) {
                ...
                Gt[X](s, Gt[e][t][n]), Qt in s||(s[Qt]=Gt[it][x][Qt]), Tt in s||(s[Tt]=Gt[it][x][Tt]), "range"in s&&(u=s.range, u=="*"?a="": u.charAt(0)=="-"?a="(max-width: "+parseInt(u[_](1))+"px)": u.charAt(u[f]-1)=="-"?a=Et+parseInt(u[_](0, u[f]-1))+"px)": Gt[R](u, "-")!=-1&&(u=u.split("-"), a=Et+parseInt(u[0])+"px) and (max-width: "+parseInt(u[1])+"px)"), s[Tt]=a), S in s&&h in s[S]&&typeof s[S][h]!=b&&(s[S][h]= {
                    vertical: s[S][h], horizontal: s[S][h]
                }
                ),
                Gt[e][t][n]=s,
                r= {},
        ...
        initElements:function() {
            ...
            switch(Gt[e].reset) {
                case"full": t[d](Gt[A]("iR", Gt[E](Gt.css.r), Z, 2));
                break;
                case Lt: t[d](Gt[A]("iN", Gt[E](Gt.css.n), Z, 2))
            }
            t[d](Gt[A]("iBM",
            Gt[E](Gt.css.bm),
            Z,
            ...
            3)),
            t[d](Gt[A]("iGR",
            Gt[E](".row>*{float:left}.row:after{content:'';display:block;clear:both;height:0}.row:first-child>*{padding-top:0!important}.row.uniform>*>:first-child{margin-top:0}.row.uniform>*>:last-child{margin-bottom:0}"),
            F,
            3)),
            Gt[ut](t)
        }
        ...
        preInit:function() {
            ...
            Gt[q][ot]>=10&&Gt[lt](Gt[A]("msie-viewport-fix",
